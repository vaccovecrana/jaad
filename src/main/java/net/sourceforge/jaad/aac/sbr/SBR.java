...
public class SBR implements Constants, net.sourceforge.jaad.aac.syntax.Constants, HuffmanTables {
  ...
  */
  ...
  public SBR(
      boolean smallFrames, boolean stereo, SampleFrequency sample_rate, boolean downSampledSBR) {
  ...
  private int sbr_process_channel(
      float[] channel_buf, float[][][] X, int ch, boolean dont_process) {
    int k, l;
    int ret = 0;
