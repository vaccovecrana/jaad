...
class HFGeneration {
  ...
  private static void auto_correlation(
      SBR sbr, acorr_coef ac, float[][][] buffer, int bd, int len) {
    ...
    ac.r12[0] =
        r01r - (temp3_r * temp2_r + temp3_i * temp2_i) + (temp5_r * temp4_r + temp5_i * temp4_i);
    ac.r12[1] =
        r01i - (temp3_i * temp2_r - temp3_r * temp2_i) + (temp5_i * temp4_r - temp5_r * temp4_i);
    ac.r22[0] =
        r11r - (temp2_r * temp2_r + temp2_i * temp2_i) + (temp4_r * temp4_r + temp4_i * temp4_i);
  ...
  private static void calc_prediction_coef(
      SBR sbr, float[][][] Xlow, float[][] alpha_0, float[][] alpha_1, int k) {
    float tmp;
    ...
    if (ac.det == 0) {
      ...
      tmp = 1.0f / ac.det;
      alpha_1[k][0] =
          ((ac.r01[0] * ac.r12[0]) - (ac.r01[1] * ac.r12[1]) - (ac.r02[0] * ac.r11[0])) * tmp;
      alpha_1[k][1] =
          ((ac.r01[1] * ac.r12[0]) + (ac.r01[0] * ac.r12[1]) - (ac.r02[1] * ac.r11[0])) * tmp;
    }
    ...
    if (ac.r11[0] == 0) {
      ...
      tmp = 1.0f / ac.r11[0];
      alpha_0[k][0] =
          -(ac.r01[0] + (alpha_1[k][0] * ac.r12[0]) + (alpha_1[k][1] * ac.r12[1])) * tmp;
      alpha_0[k][1] =
          -(ac.r01[1] + (alpha_1[k][1] * ac.r12[0]) - (alpha_1[k][0] * ac.r12[1])) * tmp;
    }
  ...
  private static float mapNewBw(int invf_mode, int invf_mode_prev) {
    switch (invf_mode) {
      case 1: /* LOW */
        if (invf_mode_prev == 0) /* NONE */ return 0.6f;
        else return 0.75f;
      ...
      default: /* NONE */
        if (invf_mode_prev == 1) /* LOW */ return 0.6f;
        else return 0.0f;
    }
  }
