...
public enum SampleFrequency {
  ...
  /**
   * Returns a sample frequency instance for the given index. If the index is not between 0 and 11
   * inclusive, SAMPLE_FREQUENCY_NONE is returned.
   *
  ...
  /**
   * Returns this sample frequency's index between 0 (96000) and 11 (8000) or -1 if this is
  ...
  /**
   * Returns the sample frequency as integer value. This may be a value between 96000 and 8000, or 0
  ...
  /**
   * Returns the highest scale factor band allowed for ICPrediction at this sample frequency. This
  ...
  /**
   * Returns the number of predictors allowed for ICPrediction at this sample frequency. This method
  ...
  /**
   * Returns the highest scale factor band allowed for TNS at this sample frequency. This method is
  ...
  /**
   * Returns a string representation of this sample frequency. The method is identical to <code>
   * getDescription()</code>.
   *
