...
/**
 * DecoderConfig that must be passed to the <code>Decoder</code> constructor. Typically it is
 * created via one of the static parsing methods.
 *
 * @author in-somnia
 */
        ...
        case ER_AAC_LD:
          ...
          if (config.frameLengthFlag)
            throw new AACException(
                "config uses 960-sample frames, not yet supported"); // TODO: are 960-frames working
          // yet?
