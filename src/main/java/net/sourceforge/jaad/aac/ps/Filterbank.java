...
class Filterbank implements PSTables {
  ...
  /* real filter, size 2 */
  static void channel_filter2(
      int frame_len, float[] filter, float[][] buffer, float[][][] X_hybrid) {
    int i;
  ...
  static void channel_filter4(
    ...
    for (i = 0; i < frame_len; i++) {
      input_re1[0] =
          -(filter[2] * (buffer[i + 2][0] + buffer[i + 10][0])) + (filter[6] * buffer[i + 6][0]);
      input_re1[1] =
          (-0.70710678118655f
      ...
      input_im1[0] =
          (filter[0] * (buffer[i + 0][1] - buffer[i + 12][1]))
      ...
      input_re2[0] =
          (filter[0] * (buffer[i + 0][0] - buffer[i + 12][0]))
      ...
      input_im2[0] =
          -(filter[2] * (buffer[i + 2][1] + buffer[i + 10][1])) + (filter[6] * buffer[i + 6][1]);
      input_im2[1] =
          (-0.70710678118655f
              * ((filter[1] * (buffer[i + 1][1] + buffer[i + 11][1]))
                  + (filter[3] * (buffer[i + 3][1] + buffer[i + 9][1]))
