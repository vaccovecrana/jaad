...
public class SampleBuffer {
  ...
  /**
   * Returns the number of bits per sample. Usually this is 16, meaning a sample is stored in two
   * bytes.
   *
  ...
  /**
   * Returns the bitrate of the decoded PCM data. <code>
   * bitrate = (samplesPerChannel * bitsPerSample) / length</code>
   *
   * @return the bitrate
   */
