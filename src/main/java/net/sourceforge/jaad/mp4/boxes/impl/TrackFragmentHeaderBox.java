...
/**
 * Each movie fragment can add zero or more fragments to each track; and a track fragment can add
 * zero or more contiguous runs of samples. The track fragment header sets up information and
 * defaults used for those runs of samples.
 *
 * @author in-somnia
 */
