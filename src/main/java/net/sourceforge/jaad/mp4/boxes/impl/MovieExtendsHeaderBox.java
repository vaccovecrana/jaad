...
/**
 * The Movie Extends Header is optional, and provides the overall duration, including fragments, of
 * a fragmented movie. If this box is not present, the overall duration must be computed by
...
public class MovieExtendsHeaderBox extends FullBox {
  ...
  /**
   * The fragment duration is an integer that declares length of the presentation of the whole movie
   ...
   * fragment duration is known in advance and this box may be omitted.
   *
