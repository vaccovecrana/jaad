...
public class VideoSampleEntry extends SampleEntry {
  ...
  /**
   * The width is the maximum visual width of the stream described by this sample description, in
   * pixels.
   */
  public int getWidth() {
    return width;
  ...
  /**
   * The height is the maximum visual height of the stream described by this sample description, in
   * pixels.
   */
  ...
  /**
   * The depth takes one of the following values DEFAULT_DEPTH (0x18) – images are in colour with no
   * alpha
   */
  public int getDepth() {
    return depth;
