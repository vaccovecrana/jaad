...
/**
 * The Original Format Box contains the four-character-code of the original un-transformed sample
 * description.
 *
 * @author in-somnia
 */
public class OriginalFormatBox extends BoxImpl {
  ...
  /**
   * The original format is the four-character-code of the original un-transformed sample entry
