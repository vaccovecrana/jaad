...
public class HintMediaHeaderBox extends FullBox {
  ...
  /**
   * The maximum PDU size gives the size in bytes of the largest PDU (protocol data unit) in this
   * hint stream.
   */
  ...
  /** The average PDU size gives the average size of a PDU over the entire presentation. */
  public long getAveragePDUsize() {
    return avgPDUsize;
  }

  /** The maximum bitrate gives the maximum rate in bits/second over any window of one second. */
  public long getMaxBitrate() {
    return maxBitrate;
  }

  /** The average bitrate gives the average rate in bits/second over the entire presentation. */
