...
public class AVCSpecificBox extends CodecSpecificBox {
  ...
  /**
   * The profileCompatibility is a byte defined exactly the same as the byte which occurs between
   * the profileIDC and levelIDC in a sequence parameter set (SPS), as defined in ISO/IEC 14496-10.
   *
  ...
  /**
   * The length in bytes of the NALUnitLength field in an AVC video sample or AVC parameter set
   * sample of the associated stream. The value of this field 1, 2, or 4 bytes.
   *
  ...
  /**
   * The SPS NAL units, as specified in ISO/IEC 14496-10. SPSs shall occur in order of ascending
   * parameter set identifier with gaps being allowed.
   *
  ...
  /**
   * The PPS NAL units, as specified in ISO/IEC 14496-10. PPSs shall occur in order of ascending
   * parameter set identifier with gaps being allowed.
   *
