...
/**
 * The entry sample descriptor (ESD) box is a container for entry descriptors. If used, it is
 * located in a sample entry. Instead of an <code>ESDBox</code> a <code>CodecSpecificBox</code> may
 * be present.
 *
 * @author in-somnia
 */
