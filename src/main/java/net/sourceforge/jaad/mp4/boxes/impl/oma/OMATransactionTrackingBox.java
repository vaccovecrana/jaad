...
/**
 * The OMA DRM Transaction Tracking Box enables transaction tracking as defined in 'OMA DRM v2.1'
 * section 15.3. The box includes a single transaction-ID and may appear in both DCF and PDCF.
 *
 * @author in-somnia
 */
