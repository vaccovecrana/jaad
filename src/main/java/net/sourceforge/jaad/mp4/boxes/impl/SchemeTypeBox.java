...
public class SchemeTypeBox extends FullBox {
  ...
  public void decode(MP4InputStream in) throws IOException {
    ...
    schemeURI =
        ((flags & 1) == 1) ? in.readUTFString((int) getLeft(in), MP4InputStream.UTF8) : null;
  }
  ...
  /**
   * The optional scheme URI allows for the option of directing the user to a web-page if they do
   * not have the scheme installed on their system. It is an absolute URI. If the scheme URI is not
