...
/**
 * The chapter box allows to specify individual chapters along the main timeline of a movie. The
 * chapter box occurs within a movie box. Defined in "Adobe Video File Format Specification v10".
 *
 * @author in-somnia
 */
