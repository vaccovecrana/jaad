...
/**
 * This box contains the data for a metadata tag. It is right below an iTunes metadata box (e.g.
 * '@nam') or a custom meta tag box ('----'). A custom meta tag box also contains a 'name'-box
 * declaring the tag's name.
 *
 * @author in-somnia
 */
...
public class ITunesMetadataBox extends FullBox {
  ...
  public enum DataType {
    ...
    private static final DataType[] TYPES = {
      IMPLICIT, UTF8, UTF16, null, null, null, HTML, XML, UUID, ISRC, MI3P, null, GIF, JPEG, PNG,
      URL, DURATION, DATETIME, GENRE, null, null, INTEGER, null, null, RIAA, UPC, null, BMP
    };
