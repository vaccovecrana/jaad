...
public interface Box {
  ...
  /**
   * Returns the offset of this box in the stream/file. This is needed as a seek point for random
   * access.
   *
  ...
  /**
   * Returns an ordered and unmodifiable list of all direct children of this box. The list does not
   * contain the children's children.
   *
  ...
  /**
   * Returns an ordered and unmodifiable list of all direct children of this box with the specified
   * type. The list does not contain the children's children. If there is no child with the given
   * type, the list will be empty.
   *
  ...
  /**
   * Returns the child box with the specified type. If this box has no child with the given type,
   * null is returned. To check if there is such a child <code>hasChild(type)</code> can be used. If
   * more than one child exists with the same type, the first one will always be returned. A list of
   * all children with that type can be received via <code>getChildren(type)</code>.
   *
   * @param type the type of child box to look for
