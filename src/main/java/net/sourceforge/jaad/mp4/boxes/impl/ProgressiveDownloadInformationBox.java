 ...
 * contains pairs of numbers (to the end of the box) specifying combinations of effective file
 * download bitrate in units of bytes/sec and a suggested initial playback delay in units of
 * milliseconds.
 *
 * <p>The download rate can be estimated from the download rate and obtain an upper estimate for a
 * suitable initial delay by linear interpolation between pairs, or by extrapolation from the first
 * or last entry.
 *
 * @author in-somnia
 */
