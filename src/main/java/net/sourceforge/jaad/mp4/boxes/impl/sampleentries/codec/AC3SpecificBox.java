...
public class AC3SpecificBox extends CodecSpecificBox {
  ...
  /**
   * This field has the same meaning and is set to the same value as the fscod field in the AC-3
   * bitstream.
   *
  ...
  /**
   * This field has the same meaning and is set to the same value as the bsid field in the AC-3
   * bitstream.
   *
  ...
  /**
   * This field has the same meaning and is set to the same value as the bsmod field in the AC-3
   * bitstream.
   *
  ...
  /**
   * This field has the same meaning and is set to the same value as the acmod field in the AC-3
   * bitstream.
   *
   * @return the value of the 'acmod' field
   */
  ...
  /**
   * This field has the same meaning and is set to the same value as the lfeon field in the AC-3
   * bitstream.
   *
  ...
  /**
   * This field indicates the data rate of the AC-3 bitstream in kbit/s, as shown in the following
   * table:
   *
   * <table>
