...
public class MediaHeaderBox extends FullBox {
  ...
  /**
   * The time-scale is an integer that specifies the time-scale for this media; this is the number
   * of time units that pass in one second. For example, a time coordinate system that measures time
  ...
  /**
   * The duration is an integer that declares the duration of this media (in the scale of the
   * timescale). If the duration cannot be determined then duration is set to -1.
   *
