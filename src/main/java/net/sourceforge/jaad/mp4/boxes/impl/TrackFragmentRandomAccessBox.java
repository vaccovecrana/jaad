...
public class TrackFragmentRandomAccessBox extends FullBox {
  ...
  /**
   * The time is an integer that indicates the presentation time of the random access sample in
   * units defined in the 'mdhd' of the associated track.
   *
  ...
  /**
   * The moof-Offset is an integer that gives the offset of the 'moof' used in the an entry. Offset
  ...
  /**
   * The 'traf' number that contains the random accessible sample. The number ranges from 1 (the
   * first 'traf' is numbered 1) in each 'moof'.
   *
  ...
  /**
   * The 'trun' number that contains the random accessible sample. The number ranges from 1 in each
   * 'traf'.
   *
  ...
  /**
   * The sample number that contains the random accessible sample. The number ranges from 1 in each
   * 'trun'.
   *
