...
/**
 * The video media header contains general presentation information, independent of the coding, for
 * video media
 *
 * @author in-somnia
 */
public class VideoMediaHeaderBox extends FullBox {
  ...
  /**
   * The graphics mode specifies a composition mode for this video track. Currently, only one mode
   * is defined: '0': copy over the existing image
   */
