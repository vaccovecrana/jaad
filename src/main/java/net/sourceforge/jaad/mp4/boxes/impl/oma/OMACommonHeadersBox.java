...
public class OMACommonHeadersBox extends FullBox {
  ...
  /**
   * The encryption method defines how the encrypted content can be decrypted. Values for the field
  ...
  /**
   * The padding scheme defines how the last block of ciphertext is padded. Values of the padding
